        ...
        reviews: [
            {
                ...
                name: "Carlos M.",
                rating: 5,
                comment: "Excelente juego, muy entretenido para jugar en familia.",
            ...
            },
            {
                ...
                name: "María P.",
                rating: 5,
                comment: "Mi juego favorito! Siempre es diferente cada partida.",
        ...
        reviews: [
            {
                ...
                name: "Pedro A.",
                rating: 5,
                comment: "Es el mejor control que he tenido.",
        ...
        reviews: [
            {
                ...
                name: "Felipe T.",
                rating: 5,
                comment: "El sonido 7.1 es increíble.",
        ...
        reviews: [
            {
                ...
                name: "Isabel B.",
                rating: 5,
                comment: "Una consola increíble. Los gráficos son de otro nivel.",
        ...
        reviews: [
            {
                ...
                name: "Daniel P.",
                rating: 5,
                comment: "Una bestia. Corre todos mis juegos en ultra.",
        ...
        reviews: [
            {
                ...
                name: "José M.",
                rating: 5,
                comment: "Es increíblemente cómoda.",
        ...
        reviews: [
            {
                ...
                name: "Gabriel N.",
                rating: 5,
                comment: "El mejor mouse para gaming.",
