...
public class DataSeeder implements CommandLineRunner {
        ...
        private void seedUsers() {
                if (userRepository.count() == 0) {
                        ...
                        u1.setPassword("admin123"); // In real app, this should be BCrypt encoded
                        u1.setRut("123456789");
                        u1.setAge(35);
                        u1.setRole("admin");
        ...
        private void seedEvents() {
                if (eventRepository.count() == 0) {
                        ...
                        Event e2 = new Event("e2", "Feria de Tecnología Gaming (LAN Party)",
                                        ...
                                        "https://maps.app.goo.gl/j5wFHYX4XuRDC9ho9",
        ...
        private void seedRewards() {
                if (rewardRepository.count() == 0) {
                        // Reward 101: Taza Gamer (Producto físico, sin descuento)
                        ...
                        r1.setStock(null); // Stock ilimitado
                        r1.setStockAvailable(null);

                        // Reward 102: Cupón $5000 (Descuento fijo)
                        ...
                        r2.setStock(null); // Stock ilimitado
                        r2.setStockAvailable(null);

                        // Reward 103: Mousepad (Producto físico)
                        ...
                        // Reward 105: Polera (Producto físico)
                        ...
                        // Reward 106: Cupón 15% OFF (Descuento porcentual)
                        ...
                        // Reward H01: Halloween 20% OFF (Stock limitado - 50 unidades)
                        ...
                        r7.setDiscountValue(0.20); // 20%
                        r7.setStock(50); // Stock limitado
                        r7.setStockAvailable(50); // Inicialmente 50 disponibles
